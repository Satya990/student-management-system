	...
	<div id="left_side">
		...
		<form action="" method="post">
			...
			<table>
				...
				<tr>
					<td>
						<input type="submit" class="search" name="edit_detail" value="Edit Detail">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" class="search" name="show_detail" value="Show Detail">
					</td>
				</tr>
			</table>
		</form>
